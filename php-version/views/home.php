...
<main class="container">
  ...
  <section class="cards-grid">
    ...
    <a href="<?= $baseDir ?>/android.php" class="panel-card glass-card reveal">
      <div class="card-badge">POPULAR</div>
      <div class="card-thumb">
        <img src="<?= $baseDir ?>/assets/img/card-android.svg" alt="Android Panel" class="card-hero-img">
      </div>
      <div class="card-body">
    ...
    <!-- Card 2: iPhone Panel -->
    <a href="<?= $baseDir ?>/ios.php" class="panel-card glass-card reveal">
      <div class="card-badge card-badge-verified">VERIFIED</div>
      <div class="card-thumb">
        <img src="<?= $baseDir ?>/assets/img/card-ios.svg" alt="iPhone Panel" class="card-hero-img">
      </div>
      <div class="card-body">
    ...
    <!-- Card 3: All Proofs -->
    <a href="<?= $baseDir ?>/proofs.php" class="panel-card glass-card reveal">
      <div class="card-badge">LIVE</div>
      <div class="card-thumb">
        <img src="<?= $baseDir ?>/assets/img/card-proofs.svg" alt="All Proofs" class="card-hero-img">
      </div>
      <div class="card-body">
    ...
    <a href="<?= $baseDir ?>/gameplay.php" class="panel-card glass-card reveal">
      <div class="card-badge">LIVE</div>
      <div class="card-thumb">
        <img src="<?= $baseDir ?>/assets/img/card-gameplay.svg" alt="Panel Gameplay" class="card-hero-img">
      </div>
      <div class="card-body">
