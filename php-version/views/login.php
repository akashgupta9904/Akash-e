  ...
  <div class="login-card">
    ...
    <form method="POST" action="">
      <div style="margin-bottom: 1rem; text-align: left;">
        ...
        <input type="text" name="username" placeholder="Enter User ID or Email" required autofocus style="width: 100%; box-sizing: border-box; background: #070e1c; border: 1px solid var(--border-green); color: #fff; padding: 12px 14px; border-radius: 10px; font-size: 1rem; outline: none;">
      </div>
      ...
      <div style="margin-bottom: 1.5rem; text-align: left;">
        ...
        <input type="password" name="password" placeholder="Enter password..." required style="width: 100%; box-sizing: border-box; background: #070e1c; border: 1px solid var(--border-green); color: #fff; padding: 12px 14px; border-radius: 10px; font-size: 1rem; outline: none;">
      </div>
